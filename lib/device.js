    ...
    _private.client
        ...
        .on("message", function(topic, payload) {
            if (isReserved(topic)) {
                ...
                var event = {
                    eventType: topicInfo[1],
                    deviceType: deviceType[0] === '.' ? deviceType.substr(1) : deviceType,
                    payload: payload
                };
...
Device.prototype.publishEvent = function(options, callback) {
    ...
    $(this).client.publish(eventType, stringOrBuffer,
        __.pick(options, "qos", "retain"), callback);
};
...
Device.prototype.unsubscribeEvent = function( options, callback ) {
    var validated = this._validateSubscribeEvent(options);
    $(this).client.unsubscribe( validated.type, callback );
};
...
Device.prototype._validateSubscribeEvent = function(options) {
    ...
    var deviceType = options.deviceType || $(this).deviceType;
    if (eventType[0] === '.') {
